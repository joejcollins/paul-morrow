<template>
  <aside :class="['main-sidebar', 'col-12', 'col-md-3', 'col-lg-3', 'px-0', sidebarVisible ? 'open' : '']">
      <div class="main-navbar">
        <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap p-0 border-bottom">
          <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
            <div class="d-table m-auto">
              ...
              <span v-if="!hideLogoText" class="d-none d-md-inline ml-1">Bristol Museum &amp; Art Gallery</span>
            </div>
          </a>
